      ...
      <section class="card">
        <div class="row" style="justify-content: space-between;">
          <div>
            ...
            <div class="card-sub">网关全局渠道状态快照。</div>
          </div>
        ...
        ${!params.snapshot
          ...
          : nothing}
        ${entries.length === 0
          ? html` <div class="muted" style="margin-top: 16px">未找到渠道。</div> `
          : html`
...
export function renderAgentCron(params: {
  ...
  return html`
    ...
    <section class="card">
      ...
      ${jobs.length === 0
        ? html` <div class="muted" style="margin-top: 16px">暂无分配的任务。</div> `
        : html`
            <div class="list" style="margin-top: 16px;">
              ${jobs.map(
                (job) => html`
    ...
    <section class="card">
      <div class="row" style="justify-content: space-between;">
        <div>
          ...
          <div class="card-sub">引导人格、身份和工具指南。</div>
        </div>
        <button
          class="btn btn--sm"
      ...
      ${!list
        ...
        : files.length === 0
          ...
          : html`
              ...
              ${!activeEntry
                ? html` <div class="muted" style="margin-top: 16px">选择要编辑的文件。</div> `
                : html`
